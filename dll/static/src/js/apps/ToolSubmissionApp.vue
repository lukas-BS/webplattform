  ...
  <app-content-submission-form
    ...
    <div v-if="mode === 'edit' || mode === 'review'">
      <app-file-input
        ...
        :review-value.sync="reviewValue.previewImage"
      ...
      <app-text-area
        ...
        :rows="3"
        :help-text="getHelpText('teaser')"></app-text-area>
      <app-dropdown
        id="co_authors"
        :readonly="readonly"
        :review="review"
      ...
      <app-dropdown
        ...
        :multiple="true"
        :prefetch="true"
        :help-text="getHelpText('functions')"></app-dropdown>
      <app-link-input
        id="url"
        :readonly="readonly"
        :review="review"
        :link.sync="data.url"
        :review-value.sync="reviewValue.url"
        :error="errorFields.includes('url')"
        label="Website"
        :type="'null'"
        :help-text="getHelpText('url')"
        :required="true"></app-link-input>
      <app-list-input
        v-if="!dltFeatures"
        :min="1"
        id="pro"
        ...
        label="Vorteile"
        :list.sync="data.pro"
        :review-value.sync="reviewValue.pro"
        :error="errorFields.includes('pro')"
        :initial="data.pro"
        :help-text="getHelpText('pro')"></app-list-input>
      <app-list-input
        v-if="!dltFeatures"
        :min="1"
        id="contra"
        ...
        :review="review"
        label="Nachteile"
        :list.sync="data.contra"
        :review-value.sync="reviewValue.contra"
        :error="errorFields.includes('contra')"
        :initial="data.contra"
        :help-text="getHelpText('contra')"></app-list-input>
      <app-select
        id="data-privacy"
        :readonly="readonly"
        :review="review"
        ...
        :value.sync="data.privacy"
        :review-value.sync="reviewValue.privacy"
        :error="errorFields.includes('privacy')"
        :default-val="data.privacy"
        :help-text="getHelpText('privacy')"></app-select>
      <app-text-area
        id="usage"
        :readonly="readonly"
        :review="review"
        label="Nutzung"
        :value.sync="data.usage"
        :review-value.sync="reviewValue.usage"
        :error="errorFields.includes('usage')"
        :character-counter="true"
        :maximal-chars="300"
        :help-text="getHelpText('usage')"></app-text-area>
      <app-dropdown
        id="applications"
        :readonly="readonly"
        :review="review"
        label="Anwendung"
        :value.sync="data.applications"
        :review-value.sync="reviewValue.applications"
        :error="errorFields.includes('applications')"
        fetch-url="/api/applications"
        :multiple="true"
        :prefetch="true"
        :help-text="getHelpText('applications')"></app-dropdown>
      <app-links-input
        id="mediaLinks"
        :readonly="readonly"
        :review="review"
      ...
      <app-select
        ...
        :value.sync="data.requires_registration"
        :review-value.sync="reviewValue.requires_registration"
        :error="errorFields.includes('requires_registration')"
        :default-val="data.requires_registration"
        :help-text="getHelpText('requires_registration')"></app-select>
      <app-select
        id="usk"
        :readonly="readonly"
        :review="review"
        ...
        :options="uskOptions"
        :value.sync="data.usk"
        :review-value.sync="reviewValue.usk"
        :error="errorFields.includes('usk')"
        :default-val="data.usk"
        :help-text="getHelpText('usk')"></app-select>
      <app-select
        id="status"
        :readonly="readonly"
        :review="review"
        ...
        :review-value.sync="reviewValue.status"
        :error="errorFields.includes('status')"
        :default-val="data.status"
        :help-text="getHelpText('status')"></app-select>
      <app-text-area
        id="additional-info"
        :readonly="readonly"
        :review="review"
      ...
      <app-dropdown
        ...
        :value.sync="data.operating_systems"
        :review-value.sync="reviewValue.operating_systems"
        :error="errorFields.includes('operating_systems')"
        fetch-url="/api/operatingSystems"
        :multiple="true"
        :prefetch="true"
        :help-text="getHelpText('operating_systems')"></app-dropdown>
      <app-dropdown
        id="subject"
        :readonly="readonly"
        :review="review"
      ...
      <app-select
        ...
        :value.sync="data.with_costs"
        :review-value.sync="reviewValue.with_costs"
        :error="errorFields.includes('with_costs')"
        :default-val="data.with_costs"
        :help-text="getHelpText('with_costs')"></app-select>
      <app-dropdown
        id="tool-potentials"
        :readonly="readonly"
        :review="review"
        ...
        :required="true"
        :value.sync="data.potentials"
        :review-value.sync="reviewValue.potentials"
        :error="errorFields.includes('potentials')"
        fetch-url="/api/potentials"
        :multiple="true"
        :prefetch="true"
        :help-text="getHelpText('potentials')"
        v-if="dltFeatures"></app-dropdown>
      <app-text-area
        id="disclaimer"
        :readonly="readonly"
        :review="review"
        label="Disclaimer"
        :value.sync="data.disclaimer"
        :review-value.sync="reviewValue.disclaimer"
        :error="errorFields.includes('disclaimer')"
        :rows="3"
        :help-text="getHelpText('disclaimer')"
        v-if="dltFeatures"></app-text-area>
      <app-links-input
        id="video_tutorials"
        :readonly="readonly"
        :review="review"
        :links.sync="data.video_tutorials"
        :review-value.sync="reviewValue.video_tutorials"
        :error="errorFields.includes('video_tutorials')"
        label="Video Anleitungen"
        :type="'video'"
        :help-text="getHelpText('video_tutorials')"
        :types="false"></app-links-input>
      <app-data-protection-input
        id="server_location"
        label="Serverstandort"
        :readonly="readonly"
        :review="review"
        :complianceText.sync="data.data_privacy_assessment.server_location_text"
        :compliance.sync="data.data_privacy_assessment.server_location"
      ...
      <app-data-protection-input
        ...
        :readonly="readonly"
        :review="review"
        :complianceText.sync="data.data_privacy_assessment.provider_text"
        :compliance.sync="data.data_privacy_assessment.provider"
        :review-value.sync="reviewValue.provider"
      ...
      <app-data-protection-input
        ...
        :readonly="readonly"
        :review="review"
        :complianceText.sync="data.data_privacy_assessment.user_registration_text"
        :compliance.sync="data.data_privacy_assessment.user_registration"
        :review-value.sync="reviewValue.user_registration"
      ...
      <app-data-protection-input
        ...
        :readonly="readonly"
        :review="review"
        :complianceText.sync="data.data_privacy_assessment.data_privacy_terms_text"
        :compliance.sync="data.data_privacy_assessment.data_privacy_terms"
        :review-value.sync="reviewValue.data_privacy_terms"
      ...
      <app-data-protection-input
        ...
        :readonly="readonly"
        :review="review"
        :complianceText.sync="data.data_privacy_assessment.terms_and_conditions_text"
        :compliance.sync="data.data_privacy_assessment.terms_and_conditions"
        :review-value.sync="reviewValue.terms_and_conditions"
      ...
      <app-data-protection-input
        ...
        :readonly="readonly"
        :review="review"
        :complianceText.sync="data.data_privacy_assessment.security_text"
        :compliance.sync="data.data_privacy_assessment.security"
        :review-value.sync="reviewValue.security"
      ...
      <app-text-area
        ...
        label="Fazit"
        :required="false"
        :value.sync="data.data_privacy_assessment.conclusion"
        :review-value.sync="reviewValue.conclusion"
