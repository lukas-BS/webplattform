      ...
      <div class="section-info">
        ...
        >
          <div class="col-12">
            <h1
              class="mb-3"
              v-html="windowCom.competenceName"
            />
          </div>
          <div
            class="col-12 mb-4"
            v-html="windowCom.videoEmbed"
          />
          <div class="col-12">
            <p>
              <b
                class="font-weight-bold"
                v-html="windowCom.competenceTextTitle"
              />
            </p>
            <p
              class="mb-5 d-lg-none"
              v-html="windowCom.competenceText"
            />
          </div>
        </div>
        <form
          ...
          <ul class="list-unstyled">
            <li class="form-check">
              ...
              <label
                ...
                for="teaching-modules-checkbox"
              >Unterrichtsbausteine</label>
            </li>
            <li class="form-check">
              <input
                id="tools-checkbox"
