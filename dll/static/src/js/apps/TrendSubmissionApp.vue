  ...
  <app-content-submission-form
    ...
    <div v-if="mode === 'edit' || mode === 'review'">
      ...
      <app-select
        ...
        :readonly="readonly"
        :review="review"
        :review-value.sync="reviewValue.category"
        :error="errorFields.includes('category')"
        label="Kategorie"
        :options="categoryOptions"
        :value.sync="data.category"
        :default-val="data.category"
        :help-text="getHelpText('category')"></app-select>
      <app-list-input
        :min="1"
        id="target-group"
        :readonly="readonly"
        :review="review"
        :review-value.sync="reviewValue.target_group"
        :error="errorFields.includes('target_group')"
        label="Zielgruppe"
        :list.sync="data.target_group"
        :initial="data.target_group"
        :help-text="getHelpText('target_group')"></app-list-input>
      <app-select
        id="language"
        :readonly="readonly"
        :review="review"
        :review-value.sync="reviewValue.language"
        :error="errorFields.includes('language')"
        label="Sprache"
        :options="languageOptions"
        :value.sync="data.language"
        :default-val="data.language"
        :help-text="getHelpText('language')"></app-select>
      <app-list-input
        :min="1"
        id="publisher"
        :readonly="readonly"
        :review="review"
        :review-value.sync="reviewValue.publisher"
        :error="errorFields.includes('publisher')"
        label="Herausgeber_in"
        :list.sync="data.publisher"
        :initial="data.publisher"
        :help-text="getHelpText('publisher')"></app-list-input>
      <app-list-input
        :min="1"
        id="goals"
        :readonly="readonly"
        ...
        :help-text="getHelpText('learning_goals')"></app-list-input>
      <app-text-area
        id="central-contents"
        :readonly="readonly"
        :review="review"
        :review-value.sync="reviewValue.central_contents"
        :error="errorFields.includes('central_contents')"
        label="Zentrale Inhalte"
        :value.sync="data.central_contents"
        :character-counter="true"
        :maximal-chars="1300"
        :help-text="getHelpText('central_contents')"></app-text-area>
      <app-text-area
        id="additional-info"
        :readonly="readonly"
        :review="review"
      ...
      <app-text-area
        ...
        :readonly="readonly"
        :review="review"
        :review-value.sync="reviewValue.citation_info"
        :error="errorFields.includes('citation_info')"
        label="Zitierhinweis"
        :value.sync="data.citation_info"
        :character-counter="true"
        :maximal-chars="200"
        :help-text="getHelpText('citation_info')"></app-text-area>
      ...
      <app-links-input
        ...
        label="Website"
        type="href"
        :help-text="getHelpText('contentlink')"></app-links-input>
      <app-links-input
        id="additionalLinks"
